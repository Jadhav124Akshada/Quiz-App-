...
export const quizData = {
  html: {title: "HTML Quiz", questions: htmlQuestions},
  css: {title: "CSS Quiz", questions: cssQuestions},
  dbms: {title: "DBMS Quiz", questions: dbmsQuestions},
  cpp: {title: "C++ Quiz", questions: cppQuestions},
  js: {title: "JavaScript Quiz", questions: jsQuestions},
  react: {title: "React Quiz", questions: reactQuestions},
  nextjs: {title: "Next.js Quiz", questions: nextjsQuestions},
  git: {title: "Git & GitHub Quiz", questions: gitQuestions},
  python: {title: "Python Quiz", questions: pythonQuestions},
  sql: {title: "SQL Quiz", questions: sqlQuestions},
  django: {title: "Django Quiz", questions: djangoQuestions},
  dsa: {title: "DSA Quiz", questions: dsaQuestions},
};
